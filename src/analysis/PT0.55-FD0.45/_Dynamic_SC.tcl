...
recorder  Node     -file  "Analysis_$n/Displacement.out"                        -time -node 4 6 8 10 -dof  1    disp;
#recorder  Node     -file  "Analysis_$n/Base_Reactions.out"                      -node 1 2 19 -dof  1  reaction  

# Beams
#recorder  Element  -file  "Analysis_$n/Beams_Global_forces.out"                 -ele  13  16  17  20  21  24  25  28 force
#recorder  Element  -file  "Analysis_$n/Beams_Global_Deformation_Sec_1.out"      -ele  13  16  17  20  21  24  25  28 section 1 deformation
#recorder  Element  -file  "Analysis_$n/Beams_Global_Deformation_Sec_4.out"      -ele  13  16  17  20  21  24  25  28 section $nI6 deformation

# Link
#recorder  Element  -file  "Analysis_$n/Links_Global_forces.out"                 -ele  63  64  65  66 -dof 2 force
#recorder  Element  -file  "Analysis_$n/Links_Deformations.out"                  -ele  63  64  65  66 deformation

# Columns
#recorder  Element  -file  "Analysis_$n/Column_Deformation_Sec_1.out"            -ele  1  2  3  4  5  6  7  8  section  1  deformation
#recorder  Element  -file  "Analysis_$n/Column_Deformation_Sec_4.out"            -ele  1  2  3  4  5  6  7  8  section  $nI6  deformation
#recorder  Element  -file  "Analysis_$n/Column_Global_forces.out"                -ele  1  2  3  4  5  6  7  8  force

# Diagonals
#recorder  Element  -file  "Analysis_$n/Diagonal_Deformation_Sec_1.out"          -ele  33  34  35  36  37  38  39  40 section  1  deformation
#recorder  Element  -file  "Analysis_$n/Diagonal_Deformation_Sec_4.out"          -ele  33  34  35  36  37  38  39  40 section  $nI6  deformation
#recorder  Element  -file  "Analysis_$n/Diagonal_Global_forces.out"              -ele  33  34  35  36  37  38  39  40 force

#recorder  Element  -file  "Analysis_$n/LeaningColumn.out"                       -ele 9 10 11 12 -dof 1 force
# ===============================================================================
